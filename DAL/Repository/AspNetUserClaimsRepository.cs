...
namespace DAL
{
    ...
    /// AspNetUserClaims
    /// </summary>
    public partial class AspNetUserClaimsRepository : BaseRepository<AspNetUserClaims>, IDisposable
    {
        /// <summary>
        /// 查询的数据
        /// </summary>
        ...
        /// <returns></returns>      
        public IQueryable<AspNetUserClaims> DaoChuData(LYProjectEntities db, string order, string sort, string search, params object[] listQuery)
        {
        ...
        /// <param name="id">一条AspNetUserClaims的主键</param>
        public void Delete(LYProjectEntities db, int id)
        {
            AspNetUserClaims deleteItem = GetById(db, id);
            if (deleteItem != null)
            { 
                db.AspNetUserClaims.Remove(deleteItem);
            }
        }
        /// <summary>
        /// 删除对象集合
        ...
        public void Delete(LYProjectEntities db, int[] deleteCollection)
        {
            //数据库设置级联关系，自动删除子表的内容   
            IQueryable<AspNetUserClaims> collection = from f in db.AspNetUserClaims
